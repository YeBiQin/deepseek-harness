...
export const zh = {
  ...
  'input.send': '发送消息',
  'input.polish': '润色',
  'input.polishBusy': '润色中…',
  'input.polishUndo': '撤销润色',
  'input.polish.basic': '基础润色',
  'input.polish.enhanced': '强化润色',
  'input.polish.expand': '上下文扩写',
...
export const en = {
  ...
  'input.polish': 'Polish',
  'input.polishBusy': 'Polishing…',
  'input.polishUndo': 'Undo polish',
  'input.polish.basic': 'Basic polish',
  'input.polish.enhanced': 'Enhanced polish',
  'input.polish.expand': 'Expand with context',
